"""
Django settings for djgmaps project.
...
SECRET_KEY = '7w159yot-6yeebh1)oy#e+sr7qtwh8^n%&&pgo6cup4)--^doc'
...
WSGI_APPLICATION = 'djgmaps.wsgi.application'
